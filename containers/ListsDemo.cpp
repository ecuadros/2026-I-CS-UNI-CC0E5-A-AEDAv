...
void DemoDoubleLinkedList(Container& dll, const string& name) {
    ...
    cout << "3. Agregando elemento por push_front:" << endl;
...
void DemoCircularLinkedList(Container& cll, const string& name) {
    ...
    // Agregar al frente
    cout << "2. Agregando al frente con push_front:" << endl;
    cll.push_front(5, 5);
    cout << "   Tamaño: " << cll.size() << endl;
...
void DemoCircularDoubleLinkedList(Container& cdll, const string& name) {
    ...
    cout << "   (Estructura bidireccional circular)" << endl;
}
...
void ListsDemo() {   
    ...
    cout << "CIRCULAR LINKED LISTS║" << endl;    
    ...
    cout << "CIRCULAR DOUBLE LISTS" << endl;
